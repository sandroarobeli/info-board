...
export default class Translator extends React.Component {
    ...
    translateIt() {
        ...
        axios.get('http://127.0.0.1:8080/translate?textToTranslate=' + this.state.textToTranslate + '&modelId=' + this.state.modelId) 
        .then(response => {
        ...
        return (
          <div className='card'>
            <div className='input-group input-group-lg'>
              ...
              <div>
                <button onClick={this.translateIt} type="button" className="btn btn-primary btn-block active">Translate</button>
